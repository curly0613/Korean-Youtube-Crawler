...
from filters_kr import Pipeline, OverlappingSubtitlesRemover, SubtitleCaptionTextFilter, SubtitleMerger,\
...
from youtube_helpers_kr import get_hash, getsize, load_all_subtitles
...
good_chars_regexp = re.compile(r"^[0-9가-힣\,\.\-\?\"\'\’\!\“\s\;\:\“\”\–\‘\’\’\/\\\~]+$")
pipeline = Pipeline([
...
if __name__ == "__main__":
    ...
    subtitle_file = video_file.replace('.mp4', '.ko.vtt')
